...
(function() {
  ...
  FlowLine = (function() {
    ...
    FlowLine.prototype.hover_start = function(event) {
      ...
      $("#from_to").html("<p><strong>" + this.left_box.label_text + "  ->  " + this.right_box.label_text + "  : " + content.length + "</strong></p>");
      $("#student_name").html("<p>" + list_to_string(content) + "</p>");
      // endof terranlee's code
  ...
  TransformationBox = (function() {
    ...
    TransformationBox.prototype.draw = function(r) {
      ...
      // new node, change color, change shape
        ...
        var point2 = "L" + (this.x+box_width).toString() + "," + (this.y + this.size()).toString();
        var point3 = "L" + this.x.toString() + "," + (this.y+this.size()).toString();
        var point4 = "L" + (this.x+box_width/2).toString() + "," + (this.y+this.size()/2).toString() + "z";
        this.box = r.path(start + point1 + point2 + point3 + point4).attr({
          "fill": c,
          "stroke": c
        });
      }
      // nactive node, change color, change shape
        ...
        var point2 = "L" + this.x.toString() + "," + (this.y+this.size()).toString() + "z";
        this.box = r.path(start + point1 + point2).attr({
          "fill": c,
          "stroke": c
        })
      }
      // only show the week at the active node
    ...
    TransformationBox.prototype.fade_unless_highlighted = function() {
      ...
      // update code by terranlee
      var op = this.sankey.opacity_highlight;
      if(!active_reg.test(this.label_text)){
        op = "0.0";
      }
      this.label.attr({
